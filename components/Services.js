...
export default function Services() {
    return (
        <div>
            ...
            <div className='flex flex-1 flex-wrap justify-center cursor-pointer '>

                <div className=" mt-20 mb-20 grid grid-cols-3 gap-4 content-center sm:flex sm:flex-col lg:flex-row lg:flex-wrap lg:ml-[6.5em] ">

                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10  border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={frontEndIcon} alt="frontendIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={backEndIcon} alt="backendIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={ecommerceIcon} alt="ecommerceIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={seoIcon} alt="SEOIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={appDevIcon} alt="appDevMobilecon" />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={sistemasIcon} alt="sistemasIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={siteIcon} alt="siteIcon" width='150em' height='150em' />
                    ...
                    <div className=' w-[30em] sm:w-[18em] sm2:w-[22em] sm3:w-[24em] md:w-[22em] lg:ml-10 lg:mt-10 border-[3px] border-[blue] py-5 text-center rounded-md hover:shadow-2xl hover:scale-105  hover:border-none' >
                        <Image src={lpIcon} alt="lpIcon" width='150em' height='150em' />
