...
export default function Navbar() {
    ...
    return (
        <nav className="z-40 mt-[-10em] w-full fixed flex filter drop-shadow-lg bg-[rgb(155,255,6)] px-4 py-4 h-20 items-center">
            ...
            <div className=" w-9/12 flex justify-end items-center">
                ...
                <div className=" hidden xl:mr-[36em] lg:flex mr-[14em] md:flex mr-[4em] md:text-lg text-xl lg:mr-[13em] xl:mr-[36em] ip:mr-10 cursor-pointer">
